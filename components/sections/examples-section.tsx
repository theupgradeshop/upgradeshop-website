  ...
  const examples = [
    {
      ...
      industry: t("example1.industry"),
      description: t("example1.body"),
      image: null, // Placeholder
      url: "#",
    },
    {
      title: t("example2.title"),
      industry: t("example2.industry"),
      description: t("example2.body"),
      image: null,
      url: "#",
    },
    {
      title: t("example3.title"),
      industry: t("example3.industry"),
      description: t("example3.body"),
      image: null,
      url: "#",
    },
  ];
      ...
      <Container className="relative z-10">
        ...
        >
          <div className="inline-block px-3 py-1 bg-gold/10 text-gold-dark text-sm font-medium rounded-full mb-6" data-field-id={getFieldId(sections, "examples", "p", 1) || undefined}>
            {getEditableText(sections, "examples", "p", t("badge"), 1)}
          </div>
